...
extern SEXP _openpopscr_C_calc_move_llk(SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP);
extern SEXP _openpopscr_C_calc_pdet(SEXP, SEXP, SEXP, SEXP, SEXP);
extern SEXP _openpopscr_C_calc_move_pdet(SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP);
...
extern SEXP _openpopscr_C_calc_movealpha(SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP);
extern SEXP _openpopscr_C_calc_movebeta(SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP);

static const R_CallMethodDef CallEntries[] = {
    {"_openpopscr_C_calc_D",          (DL_FUNC) &_openpopscr_C_calc_D,          4},
    {"_openpopscr_C_calc_llk",        (DL_FUNC) &_openpopscr_C_calc_llk,        8},
    {"_openpopscr_C_calc_move_llk",   (DL_FUNC) &_openpopscr_C_calc_move_llk,   15},
    {"_openpopscr_C_calc_pdet",       (DL_FUNC) &_openpopscr_C_calc_pdet,       5},
    {"_openpopscr_C_calc_move_pdet",  (DL_FUNC) &_openpopscr_C_calc_move_pdet,  13},
    ...
    {"_openpopscr_C_calc_movealpha",      (DL_FUNC) &_openpopscr_C_calc_movealpha,  15},
    {"_openpopscr_C_calc_movebeta",      (DL_FUNC) &_openpopscr_C_calc_movebeta,    15},
    {NULL, NULL, 0}
};
